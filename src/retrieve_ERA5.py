...
class CDSDatasetDownloader:
    ...
    def check_datasets(self):
        ...
        # to do so:
        # check if the number of files in the directory is equal to the number of months between the begin and end dates
        # check if the files are named RJ_YYYY_MM.nc from the begin to the end date:

        target_dir = Path(f"{globals.NWP_DATA_DIR}ERA5/montly_data")
